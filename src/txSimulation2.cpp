...
class sub_class{
    ...
    private:
        ros::NodeHandle n;
		ros::Publisher pubIntArray = n.advertise<std_msgs::Int32MultiArray>("txST2", 1);
        ros::Subscriber ArraySub = n.subscribe<std_msgs::Int32MultiArray>("intKey2", 1, &sub_class::SubArrayCallback,this);     
...
int main(int argc, char **argv)
{
    ...
    ros::init(argc, argv, "pubKeyboard2");
    ros::NodeHandle n;

    ros::Rate loop_rate(10);
    int num[4];
    n.getParam("/ST2num1", num[0]);
    n.getParam("/ST2num2", num[1]);
    n.getParam("/ST2num3", num[2]);
    n.getParam("/ST2num4", num[3]);
